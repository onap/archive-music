...
public class MusicCore {
    ...
    public static ResultType dropKeyspace(CassaKeyspaceObject cassaKeyspaceObject) throws MusicServiceException {
        return musicCore.dropKeyspace(cassaKeyspaceObject);
    }
    
    public static ResultType createTable(CassaTableObject cassaTableObject) throws MusicServiceException {
        return musicCore.createTable(cassaTableObject);
    }
    
    public static ResultType dropTable(CassaTableObject cassaTableObject) throws MusicServiceException {
        return musicCore.dropTable(cassaTableObject);
    }
