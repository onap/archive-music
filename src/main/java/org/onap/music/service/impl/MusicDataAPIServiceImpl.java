    ...
    public Response dropKeySpace(String version, boolean keyspace_active, String minorVersion, String patchVersion,
        ...
        try {
            ...
            if (keyspace_active) {
                 ...
                 */
                kspObject.setKeyspaceName(keyspaceName);
                ResultType result = MusicCore.dropKeyspace(kspObject, MusicUtil.EVENTUAL);
        ...
        try {
            ...
            try {
                ...
                return response.status(Status.OK)
                        .entity(new JsonResponse(MusicCore.dropTable(cassaTableObject,MusicUtil.EVENTUAL)).toMap()).build();
            } catch (MusicServiceException ex) {
