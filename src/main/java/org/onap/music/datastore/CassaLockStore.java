...
public class CassaLockStore {
	...
	private static final String table_prepend_name = "lockQ_";
...
//        System.out.println("pResult: " + pResult);
	 ...
	 * @throws MusicQueryException
	 */
	public ResultSet getLockQueue(String keyspace, String table, String key)
		...
		return dsHandle.executeEventualGet(queryObject);
	}
