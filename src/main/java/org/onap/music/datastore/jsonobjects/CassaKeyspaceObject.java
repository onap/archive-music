...
public class CassaKeyspaceObject {
	...
	public CassaKeyspaceObject setDurabilityOfWrites(String durabilityOfWrites) {
	...
	public PreparedQueryObject genCreateKeyspaceQuery() throws MusicQueryException {
		...
		if (consistency.equalsIgnoreCase(MusicUtil.EVENTUAL)
				&& this.getConsistencyInfo().get("consistency") != null) {
		...
		if (null != this.getDurabilityOfWrites()) {
