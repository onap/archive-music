...
import org.onap.music.service.impl.MusicDataAPIServiceImpl;
...
public class RestMusicDataAPI {
    ...
    public Response createKeySpace(
        ...
        MusicDataAPIService musicDataAPIService = new MusicDataAPIServiceImpl();
        
        return musicDataAPIService.createKeySpace(VERSION, true, minorVersion, patchVersion,    
                authorization, aid, ns, kspObject, keyspaceName);
    }
    ...
    public Response dropKeySpace(
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Comes inside RestMusicDataAPI dropKeySpace controller Version  :: " + version);
            logger.debug("Comes inside RestMusicDataAPI dropKeySpace controller KeySpace Name :: " + keyspaceName);
        }
        
        MusicDataAPIService musicDataAPIService = new MusicDataAPIServiceImpl();
        
        return musicDataAPIService.dropKeySpace(version, true, minorVersion, patchVersion, authorization, aid, ns, kspObject, keyspaceName);
    }
    ...
    public Response createTable(
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Comes inside RestMusicDataAPI createTable controller Version  :: " + version);
    ...
    public Response dropTable(
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Comes inside RestMusicDataAPI dropTable controller Version  :: " + version);
            logger.debug("Comes inside RestMusicDataAPI dropTable controller KeySpace Name :: " + keyspace);
        }
        
        MusicDataAPIService musicDataAPIService = new MusicDataAPIServiceImpl();
        
        return musicDataAPIService.dropTable(version, minorVersion, patchVersion, aid, ns, authorization, keyspace, tablename);
    }
