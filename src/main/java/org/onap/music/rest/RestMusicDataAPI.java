...
public class RestMusicDataAPI {
    ...
    public Response createIndex(
        ...
        try {
            ...
            JsonIndex jsonIndexObject = new JsonIndex();
            jsonIndexObject.setIndexName(indexName);
            jsonIndexObject.setKeyspaceName(keyspace);
            jsonIndexObject.setTableName(tablename);
            jsonIndexObject.setFieldName(fieldName);
