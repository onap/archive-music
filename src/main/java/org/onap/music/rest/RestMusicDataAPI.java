...
public class RestMusicDataAPI {
    ...
    public Response createKeySpace(
        ...
        if (!authMap.isEmpty()) {
            logger.error(EELFLoggerDelegate.errorLogger,"authMap is empty. verifyOnboarding may have failed silently", AppMessages.MISSINGDATA  ,ErrorSeverity.CRITICAL, ErrorTypes.AUTHENTICATIONERROR);
