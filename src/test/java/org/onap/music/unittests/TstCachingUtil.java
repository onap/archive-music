...
public class TstCachingUtil {
	...
	static String appName = TestAPISuite.appName;
	static String userId = TestAPISuite.userId;
	static String password = TestAPISuite.password;
	static String authData = TestAPISuite.authData;
	static String authorization = TestAPISuite.authorization;
	static boolean isAAF = TestAPISuite.isAAF;
	static UUID uuid = TestAPISuite.uuid;
	static String keyspaceName = TestAPISuite.keyspaceName;
	static String tableName = TestAPISuite.tableName;
    ...
    public void test_generateUUID() {
        ...
        System.out.println("Testing getUUID");
        String uuid1 = CachingUtil.generateUUID();
        String uuid2 = CachingUtil.generateUUID();
